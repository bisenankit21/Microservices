...
public class AccountController {
    ...
    private final IAccountsServce iAccountsServce;

    //constructor autowiring
    public AccountController(IAccountsServce iAccountsServce) {
        this.iAccountsServce = iAccountsServce;
    }

    @Value("${build.version}")   //we defined this value inside yml file.
    ...
    @Operation(
            ...
            description = "Contact information Details for any issue"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
